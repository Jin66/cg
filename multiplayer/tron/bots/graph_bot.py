...
class BoardTreeNode:
    ...
    def expand(self):
        ...
        for move in legal_moves:
            ...
            next_board.set_bot_position_by_idx(next_bot_id, move)
    ...
    def rollout(self):
        ...
        while count_turn < self.max_turns:
            ...
            current_board.set_bot_position_by_idx(next_bot_id, legal_moves[idx_move])
            next_bot_id = self._next_bot_id(next_bot_id)
            count_turn += 1
        if winner is None:
            self.win += 0.5
        ...
        if len(my_components) == 0:
            ...
            for move in moves:
                ...
                for bot_id in range(self.nb_players):
                    distance_to_all_cells[bot_id] = current_board.distance_all_accessible_cells(current_board.bots[bot_id])
